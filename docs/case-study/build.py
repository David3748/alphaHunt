...
def data() -> dict:
    ...
    return {
        ...
        "cutoff": {
            ...
            "full": {"n": sum(audit["memory_vs_market"]["n"].values()),
                     "did": audit["memory_vs_market"]["difference_in_differences_llm_p20_vs_mechanical"]["auc"]["point"],
                     "ci": audit["memory_vs_market"]["difference_in_differences_llm_p20_vs_mechanical"]["auc"]["ci"],
                     "lostLLM": audit["memory_vs_market"]["auc_hit"]["llm_p20"]["share_of_above_chance_skill_lost"],
                     "lostMech": audit["memory_vs_market"]["auc_hit"]["mechanical_walk_forward"]["share_of_above_chance_skill_lost"]}},
